    ...
    <div class="card-body">
        <form action="{{route('project.update', $project->id)}}" method="POST" autocomplete="off" id="edit-form"
            ...
            <div class="form-group">
                ...
                <select name="leaders[]" class="form-control select-item" multiple>
            ...
            <div class="form-group">
                ...
                <select name="members[]" class="form-control select-item" multiple>
                    <option value="">-- Please Choose --</option>
                    @foreach ($employees as $employee)
            ...
            <div class="form-group">
                ...
                <select name="priority" class="form-control select-item">
                    <option value="">-- Please Choose --</option>
            ...
            <div class="form-group">
                ...
                <select name="status" class="form-control select-item">
                    <option value="">-- Please Choose --</option>
